...
export function setStatus(status: Omit<Status, "id" | "createdAt">): void {
...
export function getStatuses(limit: number, cursor?: number): Status[] {
  return getStatusesLimit(limit, cursor);
}
